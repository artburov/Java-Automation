...
import JavaStudy.trainingWithObjects.Test2Class;
import JavaStudy.trainingWithObjects.TestClass;
...
public class Application {
    ...
    public void a (){
       ...
       System.out.println(new JavaStudy.ArrayStudy().getDefaultString());
